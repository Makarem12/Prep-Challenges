...
function fullName(arr) {
    const fullname = arr.map((obj) => obj.firstName+" "+obj.lastName)
    return fullname
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    var objWithAvg = students.map(student => ({
        firstName: student.firstName,
        lastName: student.lastName,
        gradsList: student.gradsList,
        avg: student.gradsList.reduce((sum, grade) => sum + grade, 0) / student.gradsList.length
    }))
    return objWithAvg
}
// -------------------------------------------------------------------------------------------------------
